...
const char CustomDeviceConfig[] PROGMEM =
    ...
    //"17.CC_G5_AIO.1..CCs CC_G5 XXX:8.2.3.0.encHeading:8.4.5.0.encCourse:1.6.btnHsiEncoder:8.2.3.0.kohlsEnc:8.4.5.0.encTargetAlt:8.6.7.0.encTrack:1.8.btnPfdEncoder:"
    // "17.CC_G5_HSI.1..CCs CC_G5 XXX:8.2.3.0.encHeading:8.4.5.0.encCourse:1.6.btnHsiEncoder:"
    //17.CC_G5_PFD.1..CCs CC_G5 PFD:8.2.3.0.kohlsEnc:8.4.5.0.encTargetAlt:8.6.7.0.encTrack:1.8.btnPfdEncoder:
